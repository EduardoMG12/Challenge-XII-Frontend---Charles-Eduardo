...
interface IPropsForm {
    setSucess: React.Dispatch<
        React.SetStateAction<{ formBool: boolean; returnApi: string }>
    >;
}
...
const Form: React.FC<IPropsForm> = ({ setSucess }) => {
    ...
    const onSubmit = (data: IFormState) => {
        axios
            .post(`${import.meta.env.VITE_API_LINK}/driver-application`, data)
            .then((response) => {
        ...
        <>
            ...
            >
                ...
                <div className="flex flex-col gap-[0.313rem]">
                    ...
                    {errors.country && (
                        <InputError
                            errorsMessage={errors.country.message as string}
                        />
                    )}
                </div>
                <div className="flex flex-col gap-[0.313rem]">
                ...
                <p className="font-medium text-[#FBA403] text-xl">
                ...
                <div className="flex flex-col gap-[0.313rem]">
                    ...
                    {errors.carType && (
                        <InputError errorsMessage={"Select a vehicle type"} />
                    )}
                </div>
                <button
                    type="submit"
                    className="flex justify-center items-center px-[4.625rem] py-5 self-start bg-[#FBA403] rounded-md"
                >
