...
import LogoFooterMyRide from "../icons/logoFooterMyRide";
        ...
        <footer className="h-60 max-w-full  px-20 py-10 flex items-center sm:items-start gap-20 flex-col sm:flex-row mb-10">
            <div className="flex flex-col justify-center sm:justify-start items-center sm:items-start gap-4">
                ...
                <div className="flex gap-6">
                    <a href="https://www.facebook.com/compass.uol/" target="_blank">
                        <Facebook />
                    </a>
                    <a href="https://www.instagram.com/compass.uol/" target="_blank">
                        <Instagram />
                    </a>
            ...
            <div className="flex text-white gap-20 flex-col sm:flex-row sm:gap-5">
                <div className="flex flex-col sm:w-44 gap-3">
                    ...
                    <ul className="flex flex-col gap-3">
                        ...
                        <li className="text-base cursor-pointer">How we work</li>
                    </ul>
                </div>
                ...
                <div className="flex flex-col sm:w-44 gap-3">
                    ...
                    <ul className="flex flex-col sm:w-44 gap-3">
                        ...
                        <li className="text-base cursor-pointer">Asia Office</li>
                        <li className="text-base cursor-pointer">Help Center</li>
                    </ul>
                </div>
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <ul className="flex flex-col gap-3">
                        <li className="text-base cursor-pointer">Become a partner</li>
                        <li className="text-base cursor-pointer">Partner Support</li>
                        <li className="text-base cursor-pointer">Mobile app links</li>
                    </ul>
                </div>
            </div>
        </footer>
